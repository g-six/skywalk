        ...
        <div className="is-half column">
          <div className="box">
            ...
            <div>
              ...
              <a href="https://wonderlabs.activehosted.com/f/1" target="_blank" rel="noopener noreferrer">
        ...
        <div className="is-half column">
          <div className="box">
            ...
            <div>
              ...
              <a href="https://wonderlabs.activehosted.com/f/3" target="_blank" rel="noopener noreferrer">
                <i className="icon right-arrow" />{' '}
                <span>Download our Info &amp; Pricing Sheet</span>
              </a>
            </div>
