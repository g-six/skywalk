      ...
      <div className="container values has-text-centered">
        ...
        <div className="faces">
          <figure className="image">
            <div className="image-placeholder has-background-primary">
              <img src="//wl-cebu-assets.s3.amazonaws.com/icons/customer-first.svg" />
            </div>
          ...
          <figure className="image">
            ...
            <p className="has-text-grey-light">
              Break the chains to make a change
            </p>
          </figure>
