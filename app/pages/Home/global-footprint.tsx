...
const GlobalFootprint: React.FunctionComponent = () => {
  return (
    <section id="GlobalFootprint">
      <div className="container">
        <div className="section-heading has-text-centered">
          <h2 className="has-text-grey-dark">Our Global Footprint</h2>
          <p className="has-text-grey-light">
            Singapore - Paris - Jakarta - Yogyakarta - Bandung - Ho Chi Minh
            City - Cebu - Kiev - Colombo
          </p>
        </div>
